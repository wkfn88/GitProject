...
public class Register_customer {
	...
	private void initialize() {
		...
		JLabel lblNewLabel_1_2 = new JLabel("\uC8FC\uBB38\uC790 \uC774\uB984");
		lblNewLabel_1_2.setFont(new Font("경기천년바탕 Regular", Font.PLAIN, 14));
		lblNewLabel_1_2.setBounds(31, 314, 83, 20);
		...
		JLabel lblNewLabel_1_2_1 = new JLabel("\uBC30\uC1A1\uC8FC\uC18C");
		...
		JLabel lblNewLabel_2 = new JLabel("\uAD6C\uB9E4\uC790 \uD68C\uC6D0\uAC00\uC785");
		...
		bt_ok.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if( name.equals("") || address.equals("") ) {
					JOptionPane.showMessageDialog(frame, "이름과 배송주소를 입력해주세요", "오류", JOptionPane.ERROR_MESSAGE);
					...
					dao.createCusId(id, pwd, Sname, Saddress);
